...
export const CAREER_TRACKS: CareerTrack[] = [
  {
    ...
    slots: [
      ...
      slot('Microservices', 'microservices', 1, 1, 4),
  ...
  },
  {
    ...
    slots: [
      ...
      slot('UI/UX design', ['ui-ux-design', 'figma'], 1, 1, 4),
  ...
  },
  {
    ...
    slots: [
      ...
      slot('Internationalization', 'i18n', 1, 1, 4),
      slot('Error monitoring', 'sentry', 1, 1, 4),
      slot('AR or VR', ['ar-development', 'vr-development'], 1, 1, 4),
    ],
  },
  {
    id: 'ai-ml',
  ...
  },
  {
    ...
    slots: [
      ...
      slot('Operating systems', 'operating-systems', 1, 2, 4),
