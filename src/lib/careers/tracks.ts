...
export const CAREER_TRACKS: CareerTrack[] = [
  ...
  },
  {
    ...
    blurb: 'Writes the software that runs on devices, sensors and robots.',
    slots: [
      slot('C or C++', ['c', 'cpp'], 2, 3, 1),
      slot('Python', 'python', 2, 2, 1),
      slot('Linux', 'linux-admin', 1, 2, 1),
      slot('Shell scripting', 'shell-scripting', 1, 1, 1),
      slot('Embedded systems', 'embedded-systems', 2, 3, 2),
      slot('Robotics (ROS)', 'robotics', 1, 3, 2),
      slot('Networking', 'networking', 1, 1, 2),
      slot('Unit testing', 'unit-testing', 1, 1, 2),
      slot('Real-time systems', 'real-time-systems', 1, 2, 3),
      slot('Computer vision', 'computer-vision', 1, 2, 3),
      slot('Concurrency', 'concurrency', 1, 2, 3),
      slot('CAD', 'cad', 1, 1, 3),
      slot('MATLAB', 'matlab', 1, 1, 3),
      slot('Rust', 'rust', 1, 1, 4),
      slot('GPU programming', 'cuda', 1, 1, 4),
      slot('Machine learning', 'machine-learning', 1, 1, 4),
      slot('Docker', 'docker', 1, 1, 4),
      slot('CI/CD', 'ci-cd', 1, 1, 4),
    ],
  },
]
