...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  settings: (
    <>
      ...
      <path d="M14.3 11a1.2 1.2 0 00.24 1.32l.05.04a1.45 1.45 0 11-2.05 2.05l-.04-.05a1.2 1.2 0 00-1.32-.24 1.2 1.2 0 00-.73 1.1v.12a1.45 1.45 0 01-2.9 0v-.06a1.2 1.2 0 00-.78-1.1 1.2 1.2 0 00-1.32.24l-.04.05a1.45 1.45 0 11-2.05-2.05l.05-.04a1.2 1.2 0 00.24-1.32 1.2 1.2 0 00-1.1-.73h-.12a1.45 1.45 0 010-2.9h.06a1.2 1.2 0 001.1-.78 1.2 1.2 0 00-.24-1.32l-.05-.04a1.45 1.45 0 112.05-2.05l.04.05a1.2 1.2 0 001.32.24H7a1.2 1.2 0 00.73-1.1v-.12a1.45 1.45 0 012.9 0v.06a1.2 1.2 0 00.73 1.1 1.2 1.2 0 001.32-.24l.04-.05a1.45 1.45 0 112.05 2.05l-.05.04a1.2 1.2 0 00-.24 1.32V7a1.2 1.2 0 001.1.73h.12a1.45 1.45 0 010 2.9h-.06a1.2 1.2 0 00-1.1.73z" />
    </>
  ),
  'sign-out': (
    <>
      <path d="M7 15.5H4.5A1.5 1.5 0 013 14V4a1.5 1.5 0 011.5-1.5H7" />
      <path d="M11.5 12.5L15 9l-3.5-3.5M15 9H7" />
    </>
  ),
  bug: (
    <>
      <rect x="5.5" y="6" width="7" height="8.5" rx="3.5" />
      <path d="M7 5.2a2 2 0 014 0" />
      <path d="M5.5 8.5H3M5.5 11.5H3.2M5.5 13.6l-1.9 1.4M12.5 8.5H15M12.5 11.5h2.3M12.5 13.6l1.9 1.4" />
    </>
  ),
  spark: (
    <>
      <path d="M9 2.5l1.5 4 4 1.5-4 1.5L9 13.5 7.5 9.5l-4-1.5 4-1.5L9 2.5z" />
      <path d="M14 12.2l.6 1.6 1.6.6-1.6.6-.6 1.6-.6-1.6-1.6-.6 1.6-.6.6-1.6z" />
    </>
  ),
  home: (
    <>
      <path d="M2.8 7.6L9 2.8l6.2 4.8" />
      <path d="M4.3 8.6V14a1.2 1.2 0 001.2 1.2h7a1.2 1.2 0 001.2-1.2V8.6" />
    </>
  ),
  folder: (
    <>
      <path d="M2.5 5.2a1.2 1.2 0 011.2-1.2h2.6l1.4 1.8h6.6a1.2 1.2 0 011.2 1.2v6.4a1.2 1.2 0 01-1.2 1.2H3.7a1.2 1.2 0 01-1.2-1.2V5.2z" />
    </>
  ),
}
