  ...
  return (
    <section style={{ background: C.bgDeep, borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, padding: '100px 24px', textAlign: 'center' }}>
      <div className="reveal-item" style={{ maxWidth: 760, margin: '0 auto' }}>
        <h2 style={{ fontFamily: F.mono, fontSize: 11, color: C.textFaint, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 20 }}>
          The opportunity
        </h2>
        <div style={{ fontFamily: F.serif, fontSize: 96, fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1, color: C.text, marginBottom: 16 }}>
          33.2M
        </div>
        <div style={{ fontFamily: F.mono, fontSize: 15, color: C.textMuted, marginBottom: 12 }}>
          small businesses in the U.S. — most have real CS needs and no affordable way to meet them
        </div>
        <div style={{ fontFamily: F.mono, fontSize: 11, color: C.textGhost, marginBottom: 40 }}>
          Source: SBA Office of Advocacy, 2023
        </div>
        <p style={{ fontSize: 16, color: C.textFaint, lineHeight: 1.7, maxWidth: 520, margin: '0 auto 48px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 56, flexWrap: 'wrap' }}>
          {stats.map(([stat, label]) => (
            <div key={stat} style={{ textAlign: 'center', maxWidth: 160 }}>
              ...
              <div style={{ fontSize: 11, color: C.textFaint, lineHeight: 1.5 }}>{label}</div>
            </div>
          ))}
        </div>
      </div>
